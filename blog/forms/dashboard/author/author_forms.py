    ...
    class Meta:
        ...
        widgets = {
            ...
            "last_name": forms.TextInput(
                attrs={"name": "last-name", "class": "form-control", "id": "last-name"}
            ),
            "username": forms.TextInput(
                attrs={"name": "username", "class": "form-control", "id": "username"}
            ),
        }
    ...
    class Meta:
        ...
        widgets = {
            "job_title": forms.TextInput(
                attrs={"name": "job-title", "class": "form-control", "id": "job-title"}
            ),
            "bio": forms.Textarea(
                attrs={
                    "name": "bio",
            ...
            "address": forms.TextInput(
                attrs={"name": "address", "class": "form-control", "id": "address"}
            ),
            "city": forms.TextInput(
                attrs={"name": "city", "class": "form-control", "id": "city"}
            ),
            "country": forms.TextInput(
                attrs={"name": "country", "class": "form-control", "id": "country"}
            ),
            "zip_code": forms.TextInput(
                attrs={"name": "zip-code", "class": "form-control", "id": "zip-code"}
            ),
